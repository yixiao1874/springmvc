...
public class DispatcherServlet extends HttpServlet {
    ...
    private void scanPackage(String pack) {
        URL url = this
                .getClass()
                .getClassLoader()
                .getResource("/" + replaceTo(pack));// 将所有的.转义获取对应的路径
        ...
        for (String path : fileList) {
            ...
            if (eachFile.isDirectory()) {
                scanPackage(pack + eachFile.getName());
            } else {
                packageNames.add(pack + "." + eachFile.getName());
            }
        }
    }
